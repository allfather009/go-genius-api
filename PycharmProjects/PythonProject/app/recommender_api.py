...
load_dotenv()
GEOAPIFY_API_KEY = os.getenv("779636eb19fb429fb577544f0a40d322")
AMADEUS_CLIENT_ID = os.getenv("iDryAsA3DgdzaKw6F73vGEUsG7mXh6xn")
AMADEUS_CLIENT_SECRET = os.getenv("wZor45KeeG39sW57")
